...
chuodong = class("chuodong",ctemplate)
...
function chuodong:load(data)
	...
	self:loadres(self,data.resource)
	self.id = data.id
	self.name = data.name
...
function chuodong:save()
	local data = {}
	data.resource = self:saveres(self)
	data.id = self.id
	data.name = self.name
...
function chuodong:getformdata(formname)
