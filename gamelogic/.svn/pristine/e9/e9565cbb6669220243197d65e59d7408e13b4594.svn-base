require "gamelogic.test.test_class.classa1"
require "gamelogic.test.test_class.classa2"
require "gamelogic.test.test_class.classb"
require "gamelogic.test.test_class.classc"
...
local function test()
	...
	hotfix.hotfix("gamelogic.test.test_class.classa2")
	assert(ob.desc==classa1.desc)
	assert(oc.desc==classa1.desc)
	...
	hotfix.hotfix("gamelogic.test.test_class.classa1")
