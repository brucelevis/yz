...
.PetType {
	...
	bindskills 12 : *SkillType #绑定技能
	skills 13 : *SkillType # 技能
	equips 14 : *ItemType # 装备
	chats 15 : *string	# 闲聊（1-6 case按顺序发)
	bianyi_type 16 : integer # 变异方向，0表示未变异
}
